    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "[\"2024-11-16\",\"2024-11-18\"]", null, new DateOnly(2024, 11, 19), "Sanctions", false, new DateOnly(2024, 11, 15) },
                    { 2, "[\"2024-11-26\",\"2024-11-29\",\"2024-12-01\"]", null, new DateOnly(2024, 12, 4), "C# Beginner", false, new DateOnly(2024, 11, 25) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateOnly(2024, 11, 15), false },
                    { 2, 1, new DateOnly(2024, 11, 16), true },
                    { 3, 1, new DateOnly(2024, 11, 17), false },
                    { 4, 1, new DateOnly(2024, 11, 18), true },
                    { 5, 1, new DateOnly(2024, 11, 19), false },
                    { 6, 2, new DateOnly(2024, 11, 25), false },
                    { 7, 2, new DateOnly(2024, 11, 26), true },
                    { 8, 2, new DateOnly(2024, 11, 27), false },
                    { 9, 2, new DateOnly(2024, 11, 28), true },
                    { 10, 2, new DateOnly(2024, 11, 29), true },
                    { 11, 2, new DateOnly(2024, 11, 30), false },
                    { 12, 2, new DateOnly(2024, 12, 1), true },
                    { 13, 2, new DateOnly(2024, 12, 2), false },
                    { 14, 2, new DateOnly(2024, 12, 3), false },
                    { 15, 2, new DateOnly(2024, 12, 4), false }
                });
