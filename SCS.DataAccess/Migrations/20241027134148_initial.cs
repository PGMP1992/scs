    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "[\"2024-11-07\",\"2024-11-09\"]", null, new DateOnly(2024, 11, 10), "Sanctions", false, new DateOnly(2024, 11, 6) },
                    { 2, "[\"2024-11-17\",\"2024-11-20\",\"2024-11-22\"]", null, new DateOnly(2024, 11, 25), "C# Beginner", false, new DateOnly(2024, 11, 16) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateOnly(2024, 11, 6), false },
                    { 2, 1, new DateOnly(2024, 11, 7), true },
                    { 3, 1, new DateOnly(2024, 11, 8), false },
                    { 4, 1, new DateOnly(2024, 11, 9), true },
                    { 5, 1, new DateOnly(2024, 11, 10), false },
                    { 6, 2, new DateOnly(2024, 11, 16), false },
                    { 7, 2, new DateOnly(2024, 11, 17), true },
                    { 8, 2, new DateOnly(2024, 11, 18), false },
                    { 9, 2, new DateOnly(2024, 11, 19), true },
                    { 10, 2, new DateOnly(2024, 11, 20), true },
                    { 11, 2, new DateOnly(2024, 11, 21), false },
                    { 12, 2, new DateOnly(2024, 11, 22), true },
                    { 13, 2, new DateOnly(2024, 11, 23), false },
                    { 14, 2, new DateOnly(2024, 11, 24), false },
                    { 15, 2, new DateOnly(2024, 11, 25), false }
                });
